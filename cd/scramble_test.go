...
func TestDeScramble(t *testing.T) {
	scrambledData := cd.CdSectorData{
		0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x81, 0x74, 0x61,
		...
		0x57, 0x1D, 0x1A, 0xEF, 0x48, 0x64, 0x36, 0xAB, 0x56, 0xFF, 0x7E, 0xC0, 0x20, 0xA5, 0x40, 0xC9,
		...
		0xD3, 0x23, 0x1D, 0xD9, 0xC9, 0x9A, 0x57, 0xF0, 0x12, 0x6F, 0x48, 0x54, 0x36, 0xBF, 0x56, 0xF0,
		0x3E, 0xC4, 0x10, 0xA7, 0x60, 0xC9, 0xF5, 0xD1, 0x87, 0x1C, 0x62, 0x89, 0xE9, 0xA6, 0xCE, 0xFA,
		...
		,
	}

	sector := cd.Sector{
		Data: scrambledData,
	}
	sector.Data.Descramble()

	for i := scsi.SECTOR_SYNC_SIZE + 3; i < scsi.SECTOR_DATA_SIZE; i++ {
		assert.Equal(t, sector.Data[scsi.SECTOR_SYNC_SIZE], uint8(0x00))
	}
}
